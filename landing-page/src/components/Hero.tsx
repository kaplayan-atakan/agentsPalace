...
export default function Hero() {
  return (    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-obsidian-900 bg-cyber-grid bg-grid">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-obsidian-900/80 via-obsidian-800/60 to-obsidian-700/40"></div>
        ...
        <div className="text-center">
          ...
          >            <div className="inline-flex items-center justify-center mb-4">
              <div className="relative">
                <Network className="w-16 h-16 text-electric-blue drop-shadow-neon" />
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          >            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-8 py-4 bg-gradient-to-r from-electric-purple to-electric-blue text-white font-semibold rounded-lg border-2 border-transparent hover:border-cyber-green transition-all duration-300 shadow-glow"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-transparent text-cyber-green font-semibold rounded-lg border-2 border-cyber-green hover:bg-cyber-green hover:text-black transition-all duration-300"
            >
